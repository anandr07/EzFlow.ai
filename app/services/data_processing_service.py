...
def process_data(imputation_type='mean', encoding_type='label'):  # Add encoding_type as a parameter
    ...
    # Label columns as Continuous or Categorical
    for column in processed_data.columns:
        if pd.api.types.is_numeric_dtype(processed_data[column]):
            ...
            # Encode categorical data based on user choice
    ...
    # Add logic to save labeled and encoded data in ProcessedData table
